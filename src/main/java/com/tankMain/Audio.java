...
public class Audio {
    ...
    private DataLine.Info dataLing_info = null;
    ...
    public Audio(String fileName) {
        try {
            ...
            dataLing_info = new DataLine.Info(SourceDataLine.class, audioFormat);
            sourceDataLine = (SourceDataLine) AudioSystem.getLine(dataLing_info);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
